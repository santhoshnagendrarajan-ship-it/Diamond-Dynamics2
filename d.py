...
pred_data =np.array([[np.log1p(carat), depth, table, x, y, z, np.log1p(volume), price_per_carat, cut_encoded,
...
if st.button("Predict Price"):
    ...
    #pred_data_p = scaler_P.transform(pred_data)
    price_pred = rf.predict(pred_data)[0]
